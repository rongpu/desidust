...
for program in programs:
    ...
    fns = glob.glob('/pscratch/sd/r/rongpu/ebv/spectra/y1/{}/{}/*/*/*.fits'.format(a, b))
...
cat_all = vstack(cat_all).filled(0)
cat_all.write('/global/cfs/cdirs/desicollab/users/rongpu/data/ebv/desi_stars/stars_y1.fits')
